    ...
    def __init__(self, **kwargs) -> None: 
        ...
        if dataset_path is None or not os.path.exists(dataset_path):
            if kwargs['field'] == 'q':
                ...
                encoded_dataset = encode_field(self.tokenizer, self.dataset_wrapper, 'q', 'qa1a2', truncation=True)
                ...
                self.encoded_dataset = encode_field(self.tokenizer, self.dataset_wrapper, kwargs['field'], kwargs['field_pd'], truncation=True)
